            ...
            <div className="h-screen bg-gray-200">
                <div className="flex h-screen items-center justify-center">
                    <div  className="bg-white rounded w-auto">
                        ...
                        <div className="flex justify-center text-sm text-white rounded mx-2 mt-2 mb-3 py-1 bg-blue-500 hover:bg-blue-600">
                            <button>
                                ログイン
                            </button>
                        </div>
                        <div className="border-t border-dashed border-gray-500">
                            <div className="flex justify-center text-sm text-white rounded mx-2 my-3 py-1 bg-green-500 hover:bg-green-600">
                                <button>
                                    新規登録
                                </button>
                            </div>
